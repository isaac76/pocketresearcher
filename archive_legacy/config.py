...
GEMINI_API_KEY = "AIzaSyArlvo64uf1pxhqWnswscSYY9i-CnQsevQ"  # Get from https://aistudio.google.com/
...
# Formal proof configuration
PROOF_GENERATION_FREQUENCY = 3  # Every N iterations
ENABLE_LEAN_TRANSLATION = False  # Disable to avoid API quota issues
